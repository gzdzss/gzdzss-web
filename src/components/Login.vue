<template>
    <div>
        ...
        <form>
            ...
            <button type="button" @click="authLogin('code')">去认证中心登录(code模式)</button><br>
            <button type="button" @click="authLogin('token')">去认证中心登录(token模式)</button><br>
            <br>
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            authLogin(type) {
                ...
                let redirect_uri = origin + "/oauth2";
